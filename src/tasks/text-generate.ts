import { anthropic, google, ollama, openAI, perplexity } from '../models'
import { DetailedMessage, DistilledDetailedMessage, DistilledParams, Params } from '../types'
...
type TextGenerateAnthropicModel = '@Anthropic/claude-3-haiku-20240307' | '@Anthropic/claude-3-haiku-20240307'

export type TextGenerateModel = TextGenerateOllamaModel | TextGenerateGoogleModel | TextGenerateOpenAIModel | TextGenerateOpenAIModel | TextGeneratePerplexityModel | TextGenerateAnthropicModel
